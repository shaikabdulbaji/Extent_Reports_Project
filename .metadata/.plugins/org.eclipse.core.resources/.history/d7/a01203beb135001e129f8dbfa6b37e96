package b26Configuration_using_JSON_XML_Report_theme_naming_title_time_stamp_format_CSS_style_and_JS_Code;
...
public class Demo {
	...
	public static void main(String[] args) throws IOException {
		...
		//sparkReport.loadJSONConfig(new File(System.getProperty("user.dir")+"\\src\\test\\java\\b26Configuration_using_JSON_XML_Report_theme_naming_title_time_stamp_format_CSS_style_and_JS_Code\\b26json.json"));
		
		sparkReport.loadXMLConfig(new File(System.getProperty("user.dir")+"\\src\\test\\java\\b26Configuration_using_JSON_XML_Report_theme_naming_title_time_stamp_format_CSS_style_and_JS_Code\\b26xml.xml"));
