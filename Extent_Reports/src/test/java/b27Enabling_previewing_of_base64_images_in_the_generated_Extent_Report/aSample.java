package b27Enabling_previewing_of_base64_images_in_the_generated_Extent_Report;
...
public class aSample {
	...
	public static void main(String[] args) throws IOException{
	   ...
	   //eTest.addScreenCaptureFromBase64String(takeScreenshot(), "TNinja Homepage");
	    ...
	    eTest.log(Status.INFO, MediaEntityBuilder.createScreenCaptureFromBase64String(takeScreenshot(), "TNinja Homepage").build());
	    /*
	    try {
			sparkReport.loadJSONConfig(new File(System.getProperty("user.dir")+"\\src\\test\\java\\b27Enabling_previewing_of_base64_images_in_the_generated_Extent_Report\\b27json.json"));
	    ...
	    */
	    ...
	    try {
			sparkReport.loadXMLConfig(new File(System.getProperty("user.dir")+"\\src\\test\\java\\b27Enabling_previewing_of_base64_images_in_the_generated_Extent_Report\\b27xml.xml"));
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
